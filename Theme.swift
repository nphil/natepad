...
/// Themes ported 1:1 from Homebox's web frontend, with the default customized for NatePad.
enum AppTheme: String, CaseIterable, Identifiable, Hashable {
    ...
    var colors: ThemeColors {
        ...
        switch self {
        // Default NatePad theme — security-oriented deep indigo/blue dark theme.
        case .natepad:    return ThemeColors(background: hsl(224, 25, 8), foreground: hsl(210, 40, 98), primary: hsl(245, 85, 66), accent: hsl(200, 90, 60), backgroundLightness: 0.08)
        // Standard light/dark.
